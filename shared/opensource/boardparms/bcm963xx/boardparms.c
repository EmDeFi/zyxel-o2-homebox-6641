...
enum bp_id {
...
#if 1 /* 20120906 Added by ChenHe for trunk migiration */	
  bp_usGpioLedService,
  bp_usGpioLedWaiting,
  bp_usGpioLedSys,	
  ...
  bp_usGpioDectPaging,
#endif
#if 1 /* 20121106 Added by Jayden for To2 LED control */
  bp_usGpioLedInternetFail,
  bp_usGpioLedPhone,
  bp_usGpioLedInfo,	
  bp_usGpioLedInfoFail,
   bp_usGpioLedWlan,
   bp_usGpioWlan5G,
#endif
  bp_last
...
static bp_elem_t g_bcm963168ftth[] = {
  {bp_cpBoardId,               .u.cp = "963168FTTH"},
  {bp_ulDeviceOptions,         .u.ul = BP_DEVICE_OPTION_ENABLE_GMAC },
  {bp_usGpioOverlay,           .u.ul =(BP_OVERLAY_SERIAL_LEDS |
                                       BP_OVERLAY_PCIE_CLKREQ |
                                       BP_OVERLAY_HS_SPI_SSB6_EXT_CS)},
#ifdef BUILD_5G
  {bp_usGpio5GPwrCtl,          .u.us = BP_GPIO_9_AH},
#endif
#ifdef BUILD_HPNA
  {bp_usGpioHpnaReset,		   .u.us = BP_GPIO_11_AL},
#endif
  {bp_usGpioLedWpsFail,        .u.us = BP_GPIO_15_AH},
  {bp_usGpioLedSesWireless,    .u.us = BP_GPIO_16_AH},
  {bp_usGpioLedWanError,       .u.us = BP_GPIO_18_AH},
  {bp_usGpioLedSysFail,        .u.us = BP_GPIO_19_AH},
  {bp_usGpioLedBlPowerOn,      .u.us = BP_GPIO_20_AL},
#ifdef BUILD_5G
  {bp_usGpio5GReset,           .u.us = BP_GPIO_23_AH},
#endif
  {bp_usGpioVoip1Led,          .u.us = BP_SERIAL_GPIO_3_AL},
  {bp_usGpioVoip2Led,          .u.us = BP_SERIAL_GPIO_2_AL},
  {bp_usGpioVoip1LedFail,      .u.us = BP_SERIAL_GPIO_11_AL},
  {bp_usGpioVoip2LedFail,      .u.us = BP_SERIAL_GPIO_15_AL},
  {bp_usGpioLedUSB0Fail,       .u.us = BP_SERIAL_GPIO_4_AL},
  {bp_usGpioLedUSB0,           .u.us = BP_SERIAL_GPIO_5_AL},
  {bp_usGpioLedWanData,        .u.us = BP_SERIAL_GPIO_8_AL},
  {bp_usGpioLed5GWpsFail,        .u.us = BP_SERIAL_GPIO_10_AL},
  {bp_usGpioLedUSB1,           .u.us = BP_SERIAL_GPIO_13_AL},
  {bp_usExtIntrResetToDefault, .u.us = BP_EXT_INTR_0}, 
  {bp_usExtIntrSesBtnWireless, .u.us = BP_EXT_INTR_1},  
  {bp_usAntInUseWireless,      .u.us = BP_WLAN_ANT_MAIN},
  {bp_usWirelessFlags,         .u.us = 0},
  ...
  {bp_ulPhyId6,                .u.ul = 0xff | RGMII_DIRECT},
  {bp_ucPhyType1,              .u.uc = BP_ENET_EXTERNAL_SWITCH},
  {bp_ucPhyAddress,            .u.uc = 0x0},
  {bp_usConfigType,            .u.us = BP_ENET_CONFIG_HS_SPI_SSB_6},
  /*bp_ulPortMap:	bit 0:reserved,  bit 1~4: LAN port, bit 5: hpna port*/ 
#ifdef BUILD_HPNA
  ...
  /*configure external switch port 5 as hpna*/
#ifdef BUILD_HPNA
  {bp_ulPhyId5,                .u.ul =  0x14 | MII_DIRECT_HPNA},
#endif
  {bp_ucDspType0,              .u.uc = BP_VOIP_MIPS},
  {bp_ucDspAddress,            .u.uc = 0},
  {bp_last}
...
static bp_elem_t g_bcm963168miniftth[] = {
  {bp_cpBoardId,               .u.cp = "963168MINIFTTH"},
  {bp_ulDeviceOptions,         .u.ul = BP_DEVICE_OPTION_ENABLE_GMAC },
  {bp_usGpioOverlay,           .u.ul =(BP_OVERLAY_SERIAL_LEDS |
                                       BP_OVERLAY_PCIE_CLKREQ |
                                       BP_OVERLAY_HS_SPI_SSB6_EXT_CS)},
  {bp_usGpioLedWpsFail,        .u.us = BP_GPIO_15_AL},
  {bp_usGpioLedSesWireless,    .u.us = BP_GPIO_16_AH},
  {bp_usGpioLedWanError,       .u.us = BP_GPIO_18_AH},
  {bp_usGpioLedSysFail,        .u.us = BP_GPIO_19_AH},
  {bp_usGpioLedBlPowerOn,      .u.us = BP_GPIO_20_AL},
...
static bp_elem_t g_bcm963168vx5g[] = {
  {bp_cpBoardId,               .u.cp = "963168VX5G"},
  ...
  {bp_usGpioLedUSB0,        .u.us = BP_SERIAL_GPIO_5_AH},
  {bp_usGpioLedUSB0Fail,        .u.us = BP_SERIAL_GPIO_6_AH},
  {bp_usGpioLedUSB1,        .u.us = BP_SERIAL_GPIO_13_AH},
  /*{bp_usGpioLedBlStop,         .u.us = BP_GPIO_21_AL},*/
  {bp_usGpioHpnaReset,         .u.us = BP_GPIO_23_AL},
  {bp_usExtIntrResetToDefault, .u.us = BP_EXT_INTR_0},
  {bp_usExtIntrSesBtnWireless, .u.us = BP_EXT_INTR_1},
  {bp_usAntInUseWireless,      .u.us = BP_WLAN_ANT_MAIN},
  {bp_usWirelessFlags,         .u.us = 0},
  ...
  {bp_ulPhyId2,                .u.ul = 0x03},
  {bp_ulPhyId3,                .u.ul = 0x04},
  {bp_ulPhyId4,                .u.ul = 0xff | RGMII_DIRECT},
  {bp_ucDspType0,              .u.uc = BP_VOIP_MIPS},
  {bp_ucDspAddress,            .u.uc = 0},
  {bp_ulAfeId0,                .u.ul = 0x10608700},
  {bp_usGpioVoip1Led,          .u.us = BP_SERIAL_GPIO_3_AL},
  {bp_usGpioVoip2Led,          .u.us = BP_SERIAL_GPIO_2_AL},
  {bp_usGpioVoip1LedFail,          .u.us = BP_SERIAL_GPIO_1_AL},
  {bp_usGpioVoip2LedFail,          .u.us = BP_SERIAL_GPIO_0_AL},
  {bp_last}
};


static bp_elem_t g_bcm963168vxhpna[] = {
  {bp_cpBoardId,               .u.cp = "963168VXHPNA"},
  {bp_usGpioOverlay,           .u.ul =(BP_OVERLAY_PHY |
                                       BP_OVERLAY_SERIAL_LEDS |
                                       BP_OVERLAY_USB_DEVICE)},
  {bp_usGpioLedAdsl,           .u.us = BP_GPIO_15_AH},
  ...
  {bp_ulPhyId2,                .u.ul = 0x03},
  {bp_ulPhyId3,                .u.ul = 0x04},
  {bp_ulPhyId4,                .u.ul = 0x14 | MII_DIRECT_HPNA},
  {bp_ucDspType0,              .u.uc = BP_VOIP_MIPS},
  {bp_ucDspAddress,            .u.uc = 0},
  {bp_ulAfeId0,                .u.ul = 0x10608700},
  {bp_usGpioVoip1Led,          .u.us = BP_SERIAL_GPIO_3_AL},
...
static bp_elem_t g_bcm963168ftth5g[] = {
  {bp_cpBoardId,               .u.cp = "963168FTTH5G"},
  {bp_ulDeviceOptions,         .u.ul = BP_DEVICE_OPTION_ENABLE_GMAC },
  {bp_usGpioOverlay,           .u.ul =(BP_OVERLAY_SERIAL_LEDS |
                                       BP_OVERLAY_PCIE_CLKREQ |
                                       BP_OVERLAY_HS_SPI_SSB6_EXT_CS)},
  ...
  {bp_usConfigType,            .u.us = BP_ENET_CONFIG_MMAP},
  {bp_ulPortMap,               .u.ul = 0x58},
  {bp_ulPhyId3,                .u.ul = BP_PHY_ID_4|BCM_WAN_PORT},
  {bp_ulPhyId4,                .u.ul = RGMII_DIRECT | EXTSW_CONNECTED},
  {bp_ulPhyId6,                .u.ul = 0xff | RGMII_DIRECT},
  {bp_ucPhyType1,              .u.uc = BP_ENET_EXTERNAL_SWITCH},
  {bp_ucPhyAddress,            .u.uc = 0x0},
...
int hwType = HW_5G_IAD;
/*Jayden@MSTC add for taking off BUILD_5G featrue*/
#else 
static bp_elem_t g_bcm963168vx5g[] = {
  {bp_cpBoardId,               .u.cp = "963168VX5G"},
  {bp_usGpioOverlay,           .u.ul =(BP_OVERLAY_PHY |
                                       BP_OVERLAY_SERIAL_LEDS |
                                       BP_OVERLAY_USB_DEVICE)},
  {bp_usGpioDectPaging,		.u.us = BP_GPIO_20_AL},  
  {bp_usGpioLedSys,			.u.us = BP_SERIAL_GPIO_0_AL},  
  {bp_usGpioLedSysFail,              	.u.us = BP_SERIAL_GPIO_1_AL},  
  {bp_usGpioLedAdsl,           		.u.us = BP_SERIAL_GPIO_2_AL},  
  {bp_usGpioLedInternet,             .u.us = BP_SERIAL_GPIO_3_AL},  
  {bp_usGpioLedSesWireless,    	.u.us = BP_SERIAL_GPIO_4_AL},  
  {bp_usGpioDectLed,           	.u.us = BP_SERIAL_GPIO_5_AL},  
  {bp_usGpioLedService,             	.u.us = BP_SERIAL_GPIO_6_AL},  
  {bp_usGpioLedWaiting,             	.u.us = BP_SERIAL_GPIO_7_AL},  
  {bp_usExtIntrResetToDefault, 	.u.us = BP_EXT_INTR_0},  
  {bp_usExtIntrSesBtnWireless, 	.u.us = BP_EXT_INTR_1},  
  {bp_usAntInUseWireless,      	.u.us = BP_WLAN_ANT_MAIN},  
  {bp_usWirelessFlags,         		.u.us = 0},  
...
static bp_elem_t g_bcm963168vxTo2[] = {
  {bp_cpBoardId,               .u.cp = "963168VXTo2"},
  {bp_usGpioOverlay,           .u.ul =(BP_OVERLAY_PHY |
                                       BP_OVERLAY_SERIAL_LEDS |
                                       BP_OVERLAY_GPHY_LED_0 |				/* To Enable ethernet Data ACT - be a HW function, ref setup.c setting*/
                                       BP_OVERLAY_USB_DEVICE)},
  {bp_usGpioDectPaging,		.u.us = BP_GPIO_20_AL},  
  {bp_usGpioLedBlPowerOn,		.u.us = BP_SERIAL_GPIO_0_AL},  
  {bp_usGpioLedBlStop,              	.u.us = BP_SERIAL_GPIO_1_AL},
  {bp_usGpioLedAdsl,           		.u.us = BP_GPIO_17_AL},  			/* For DSL status LED */
  {bp_usGpioLedInternet,             .u.us = BP_SERIAL_GPIO_4_AH},  	/* For Internet LED. A global switch */
  {bp_usGpioLedInternetFail,        .u.us = BP_SERIAL_GPIO_5_AL}, 	/* For Internet LED. Red color */
  {bp_usGpioLedWanData, 		.u.us = BP_SERIAL_GPIO_8_AL},		/* For DSL Data ACT */
  {bp_usGpioLedPhone,    	       .u.us = BP_SERIAL_GPIO_3_AL},   
  {bp_usGpioLedInfo,             	.u.us = BP_SERIAL_GPIO_6_AL},  
  {bp_usGpioLedInfoFail,             	.u.us = BP_SERIAL_GPIO_9_AL},  /* For C3-5 */
  {bp_usGpioDectLed, 			.u.us = BP_GPIO_16_AL},
  {bp_usGpioLedWlan, 			.u.us = BP_SERIAL_GPIO_10_AH}, 	/* For WLAN LED. A global switch */
  {bp_usGpioWlan5G, 			.u.us = BP_GPIO_35_AH},			/* For WLAN LED. A local switch only for 5g ACT */
  {bp_usExtIntrResetToDefault, 	.u.us = BP_EXT_INTR_0},  
  {bp_usExtIntrSesBtnWireless, 	.u.us = BP_EXT_INTR_1},  
  {bp_usAntInUseWireless,      	.u.us = BP_WLAN_ANT_MAIN},  
  {bp_usWirelessFlags,         		.u.us = 0},  
  ...
  {bp_usGpioExtAFELDClk,       	.u.us = BP_GPIO_8_AL},
  {bp_usGpioExtAFELDData,      	.u.us = BP_GPIO_11_AH},
  {bp_usGpioExtAFEReset,       	.u.us = BP_GPIO_15_AL},
  {bp_ulAfeId0,                		.u.ul = 0x30820100},  /* BP_AFE_CHIP_6306 | BP_AFE_LD_6303 | BP_AFE_FE_ANNEXBJ | BP_AFE_FE_REV_6302_REV1 */
  {bp_usGpioUart2Sdin,			.u.us = BP_GPIO_12_AH},  
  {bp_usGpioUart2Sdout, 		.u.us = BP_GPIO_13_AH},  
  {bp_last}
};
static bp_elem_t g_bcm963168vxTo2_1[] = {
  {bp_cpBoardId,               .u.cp = "963168VXTo2_1"},
  {bp_usGpioOverlay,           .u.ul =(BP_OVERLAY_PHY |
                                       BP_OVERLAY_SERIAL_LEDS |
                                       BP_OVERLAY_USB_DEVICE)},
  {bp_usGpioDectPaging,		.u.us = BP_GPIO_20_AL},  
  #if 1 /*20121106  modified by Jayden  for To2 LED test*/
  {bp_usGpioLedBlPowerOn,		.u.us = BP_SERIAL_GPIO_0_AL},  
  {bp_usGpioLedBlStop,              	.u.us = BP_SERIAL_GPIO_1_AL},
  {bp_usGpioLedSys,			.u.us = BP_SERIAL_GPIO_0_AL},  
  {bp_usGpioLedSysFail,              	.u.us = BP_SERIAL_GPIO_1_AL},  
  ...
  {bp_usGpioLedInternetFail,        .u.us = BP_SERIAL_GPIO_5_AL}, 
  {bp_usGpioLedPhone,    	       .u.us = BP_SERIAL_GPIO_8_AL},   
  {bp_usGpioLedInfo,             	.u.us = BP_SERIAL_GPIO_14_AL},  
  {bp_usGpioLedInfoFail,             	.u.us = BP_SERIAL_GPIO_15_AL},  
  {bp_usGpioDectLed, 			.u.us=BP_GPIO_16_AL},
  {bp_usGpioLedSesWireless, 	.u.us=BP_GPIO_36_AH},
  #endif /*20121106  modified by Jayden  for To2 LED test*/
  {bp_usExtIntrResetToDefault, 	.u.us = BP_EXT_INTR_0},  
  {bp_usExtIntrSesBtnWireless, 	.u.us = BP_EXT_INTR_1},  
  {bp_usAntInUseWireless,      	.u.us = BP_WLAN_ANT_MAIN},  
  {bp_usWirelessFlags,         		.u.us = 0},  
...
#endif //BUILD_MSTC_FW_WITH_DIFFERENT_HW
...
#ifdef BUILD_MSTC_FW_WITH_DIFFERENT_HW
static bp_elem_t * g_BoardParms[] = {g_bcm963268sv1, g_bcm963268mbv, g_bcm963168vx, g_bcm963168vx5g, g_bcm963168vxhpna, g_bcm963168ftth, g_bcm963168miniftth, g_bcm963168ftth5g, g_bcm963168vx_p300, g_bcm963268bu, g_bcm963268bu_p300, g_bcm963268sv2_extswitch, g_bcm963168mbv_17a, g_bcm963168mbv_30a, g_bcm963168xh, g_bcm963168xh5, g_bcm963168mp, g_bcm963268v30a, g_bcm963168media, g_bcm963268sv2, g_bcm963168xfg3, g_bcm963168xf, g_bcm963168xm, g_bcm963168mbv3, g_bcm963168mbv17a302, g_bcm963168mbv30a302, 0};
#else
static bp_elem_t * g_BoardParms[] = {g_bcm963168vxTo2, g_bcm963168vxTo2_1, g_bcm963168vx5g, g_bcm963268sv1, g_bcm963268mbv, g_bcm963168vx, g_bcm963168ftth, g_bcm963168miniftth, g_bcm963168vx_p300, g_bcm963268bu, g_bcm963268bu_p300, g_bcm963268sv2_extswitch, g_bcm963168mbv_17a, g_bcm963168mbv_30a, g_bcm963168xh, g_bcm963168xh5, g_bcm963168mp, g_bcm963268v30a, g_bcm963168media, g_bcm963268sv2, g_bcm963168xfg3, g_bcm963168xf, g_bcm963168xm, g_bcm963168mbv3, g_bcm963168mbv17a302, g_bcm963168mbv30a302, 0};
#endif //BUILD_MSTC_FW_WITH_DIFFERENT_HW
...
} /* BpGetFXS1LedFailGpio */

/**************************************************************************
* Name       : BpGetFXS2LedFailGpio
*
* Description: This function returns the GPIO pin assignment for the VDSL
*              LED.
*
...
} /* BpGetFXS2LedFailGpio */
#if 1 /* Jayden@MSTC for LED control */
int BpGetSysLedGpio( unsigned short *pusValue )
{
    return( BpGetUs(bp_usGpioLedSys, pusValue ) );
}/*for Q0*/
int BpGetSysFailLedGpio( unsigned short *pusValue )
{
    return( BpGetUs(bp_usGpioLedSysFail, pusValue ) );
}/*for Q1*/
...
int BpGetServiceLedGpio( unsigned short *pusValue )
{
    return( BpGetUs(bp_usGpioLedService, pusValue ) );
}/*for Q6*/
int BpGetWaitingLedGpio( unsigned short *pusValue )
{
    return( BpGetUs(bp_usGpioLedWaiting, pusValue ) );
}/*for Q7*/
#endif

#if 1 /* 20121106 added by Jayden for To2 LED control */
/*added to be used for To2 */
int BpGetInternetFailLedGpio( unsigned short *pusValue )
{
    return( BpGetUs(bp_usGpioLedInternetFail, pusValue ) );
}
int BpGetPhoneLedGpio( unsigned short *pusValue )
{
    return( BpGetUs(bp_usGpioLedPhone, pusValue ) );
}
int BpGetInfoLedGpio( unsigned short *pusValue )
{
    return( BpGetUs(bp_usGpioLedInfo, pusValue ) );
}
int BpGetInfoFailLedGpio( unsigned short *pusValue )
{
    return( BpGetUs(bp_usGpioLedInfoFail, pusValue ) );
}
int BpGetWlanLedGpio( unsigned short *pusValue )
{
    return( BpGetUs(bp_usGpioLedWlan, pusValue ) );
}
int BpGetWlanLedGpio5G( unsigned short *pusValue )
{
    return( BpGetUs(bp_usGpioWlan5G, pusValue ) );
}
#endif
...
/**************************************************************************
* Name       : BpGetWirelessWpsErrLedGpio
*
* Description: This function returns the GPIO pin assignment for the Wireless Wps Err Led.
*
* Parameters : [OUT] pusValue - Address of short word that the Wireless Ses
*                  Led GPIO pin is returned in.
*
...
***************************************************************************/
int BpGetWirelessWpsErrLedGpio( unsigned short *pusValue )
{
    return( BpGetGpio(bp_usGpioLedWpsFail, pusValue ) ) ;
} 
...
#if 1 /*Jayden@MSTC support HW to change ,20121105*/
static WLAN_SROM_ENTRY wlan_patch_unique_963168VXTo2[]={
    {0, 0}
};
...
#if 1 /*Jayden@MSTC support HW to change ,20121105*/ /* ChenHe@MSTC update for C2-3, 20130306*/
static WLAN_SROM_ENTRY wlan_patch_common_963168VXTo2[] = {
    { 80, 0x0707},
    { 81, 0x4545},
    { 82, 0x4545},
    { 83, 0x4545},
...
#if 1 /*Jayden@MSTC support HW to change ,20121105*/
    {"963168VXTo2",  0x4360, 220,wlan_patch_unique_963168VXTo2,     wlan_patch_common_963168VXTo2},
    {"963168VXTo2",  0x6362, 220, wlan_patch_unique_963268MBV,     wlan_patch_common_963268MBV},	/* ChenHe@MSTC Support onboard 2.4G internal PA, 20121119 */
#endif /*Jayden@MSTC support HW to change ,20121105*/
#endif
...
static WLAN_PCI_PATCH_INFO wlanPciInfo[]={
    ...
    {"",       0,      0}}},
    /* this is the patch to boardtype(boardid) for 963168FTTH */
    {"963168FTTH", 0x435f14e4, 64,
    {{"subpciids", 11, 0x5A814e4},
    {"",       0,      0}}},
#endif
    {"",                 0, 0, {{"",       0,      0}}}, /* last entry*/
...
*                  for the board.
***************************************************************************/
int BpGet5GWpsLedGpio( unsigned short *pusValue )
{
    return( BpGetUs(bp_usGpioLed5GWps, pusValue ) );
} /* BpGet5GWpsLedGpio */

/**************************************************************************
* Name       : BpGet5GWpsFailLedGpio
*
* Description: This function returns the GPIO pin assignment for the VoIP2
*              Fail LED which is used when there's an error with FXS1
* Parameters : [OUT] pusValue - Address of short word that the VoIP2
...
*                  for the board.
***************************************************************************/
int BpGet5GWpsFailLedGpio( unsigned short *pusValue )
{
    return( BpGetUs(bp_usGpioLed5GWpsFail, pusValue ) );
} /* BpGet5GWpsFailLedGpio */
...
/**************************************************************************
* Name       : BpGetDECTPagingGpio
*
* Description: This function returns the GPIO pin assignment for the DECT.
*              Paging button which is used when DECT is active
* Parameters : [OUT] pusValue - Address of short word that the DECT
*              Paging GPIO pin is returned in.
*
* Returns    : BP_SUCCESS - Success, value is returned.
*              BP_BOARD_ID_NOT_SET - Error, BpSetBoardId has not been called.
*              BP_VALUE_NOT_DEFINED - At least one return value is not defined
*                  for the board.
***************************************************************************/
int BpGetDECTPagingGpio( unsigned short *pusValue )
{
    return( BpGetGpio(bp_usGpioDectPaging, pusValue ) );
} /* BpGetDECTPagingGpio */
...
{
    return( BpGetUs(bp_usGpioLedETH0, pusValue ) );
}

int BpGetEth1LedGpio( unsigned short *pusValue )
{
    return( BpGetUs(bp_usGpioLedETH1, pusValue ) );
}

int BpGetEth2LedGpio( unsigned short *pusValue )
{
    return( BpGetUs(bp_usGpioLedETH2, pusValue ) );
}

int BpGetEth3LedGpio( unsigned short *pusValue )
{
    return( BpGetUs(bp_usGpioLedETH3, pusValue ) );
}

// Mitrastar Ruki LED 2011.04.21
/**************************************************************************
* Name       : BpGetEphy0DuplexLedGpio
*
* Description: 
*
* Parameters : [OUT] pusValue - Address of short word that the alarm LED
...
{
    return( BpGetUs(bp_usGpioLedEphy0Duplex, pusValue ) );
} /* BpGetEphy0DuplexLedGpio */

// Mitrastar Ruki LED 2011.04.21
/**************************************************************************
* Name       : BpGetEphy1DuplexLedGpio
*
* Description: 
*
* Parameters : [OUT] pusValue - Address of short word that the alarm LED
...
{
    return( BpGetUs(bp_usGpioLedEphy1Duplex, pusValue ) );
} /* BpGetEphy1DuplexLedGpio */

// Mitrastar Ruki LED 2011.04.21
/**************************************************************************
* Name       : BpGetEphy2DuplexLedGpio
*
* Description: 
*
* Parameters : [OUT] pusValue - Address of short word that the alarm LED
...
{
    return( BpGetUs(bp_usGpioLedEphy2Duplex, pusValue ) );
} /* BpGetEphy2DuplexLedGpio */

// Mitrastar Ruki LED 2011.04.21
/**************************************************************************
* Name       : BpGetGphyDuplexLedGpio
*
* Description: 
*
* Parameters : [OUT] pusValue - Address of short word that the alarm LED
...
{
    return( BpGetUs(bp_usGpioLedGphyDuplex, pusValue ) );
} /* BpGetGphyDuplexLedGpio */

// Mitrastar Ruki LED 2011.04.21
/**************************************************************************
* Name       : BpGetEphy0ActLedGpio
*
* Description: 
*
* Parameters : [OUT] pusValue - Address of short word that the alarm LED
...
{
    return( BpGetUs(bp_usGpioLedEphy0Act, pusValue ) );
} /* BpGetEphy0ActLedGpio */

// Mitrastar Ruki LED 2011.04.21
/**************************************************************************
* Name       : BpGetEphy1ActLedGpio
*
* Description: 
*
* Parameters : [OUT] pusValue - Address of short word that the alarm LED
...
{
    return( BpGetUs(bp_usGpioLedEphy1Act, pusValue ) );
} /* BpGetEphy1ActLedGpio */

// Mitrastar Ruki LED 2011.04.21
/**************************************************************************
* Name       : BpGetEphy2ActLedGpio
*
* Description: 
*
* Parameters : [OUT] pusValue - Address of short word that the alarm LED
...
{
    return( BpGetUs(bp_usGpioLedEphy2Act, pusValue ) );
} /* BpGetEphy2ActLedGpio */

// Mitrastar Ruki LED 2011.04.21
/**************************************************************************
* Name       : BpGetGphyActLedGpio
*
* Description: 
*
* Parameters : [OUT] pusValue - Address of short word that the alarm LED
...
{
    return( BpGetUs(bp_usGpioLedGphyAct, pusValue ) );
} /* BpGetGphyActLedGpio */

// Mitrastar Ruki LED 2011.04.21
/**************************************************************************
* Name       : BpGetEphy0SpeedLedGpio
*
* Description: 
*
* Parameters : [OUT] pusValue - Address of short word that the alarm LED
...
{
    return( BpGetUs(bp_usGpioLedEphy0Speed, pusValue ) );
} /* BpGetEphy0SpeedLedGpio */

// Mitrastar Ruki LED 2011.04.21
/**************************************************************************
* Name       : BpGetEphy1SpeedLedGpio
*
* Description: 
*
* Parameters : [OUT] pusValue - Address of short word that the alarm LED
...
{
    return( BpGetUs(bp_usGpioLedEphy1Speed, pusValue ) );
} /* BpGetEphy1SpeedLedGpio */

// Mitrastar Ruki LED 2011.04.21
/**************************************************************************
* Name       : BpGetEphy2SpeedLedGpio
*
* Description: 
*
* Parameters : [OUT] pusValue - Address of short word that the alarm LED
...
{
    return( BpGetUs(bp_usGpioLedEphy2Speed, pusValue ) );
} /* BpGetEphy2SpeedLedGpio */

// Mitrastar Ruki LED 2011.04.21
/**************************************************************************
* Name       : BpGetGphySpeedLedGpio
*
* Description: 
*
* Parameters : [OUT] pusValue - Address of short word that the alarm LED
...
{
    return( BpGetUs(bp_usGpioLedGphySpeed, pusValue ) );
} /* BpGetGphySpeedLedGpio */

// Mitrastar Ruki LED 2011.04.21
/**************************************************************************
* Name       : BpGetDslLinkLedGpio
*
* Description: 
*
* Parameters : [OUT] pusValue - Address of short word that the alarm LED
...
{
    return( BpGetUs(bp_usGpioLedDslLink, pusValue ) );
} /* BpGetDslLinkLedGpio */
...
*              Reset signal.
*
* Parameters : [OUT] pusValue - Address of short word that the HPNA Reset
*                  signal GPIO pin is returned in.
*
* Returns    : BP_SUCCESS - Success, value is returned.
*              BP_BOARD_ID_NOT_SET - Error, BpSetBoardId has not been called.
...
*                  for the board.
***************************************************************************/
int BpGet5GPwrCtlGpio( unsigned short *pusValue ) {
	return( BpGetUs(bp_usGpio5GPwrCtl, pusValue ) );
} /*BpGet5GPwrCtlGpio*/
#endif

#ifdef BUILD_HPNA //__MTSC__, Delon Yu, Support HPNA
/**************************************************************************
* Name       : BpGetHpnaResetGpio
*
* Description: This function returns the GPIO pin assignment for the HPNA
*              Reset signal.
*
...
int BpGetHpnaResetGpio( unsigned short *pusValue ) {
    return( BpGetUs(bp_usGpioHpnaReset, pusValue ) );
} /*BpGetHpnaResetGpio*/
#endif
